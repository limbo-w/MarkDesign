    ...
    <div class="w-full">
        <div class="flex items-center border-b py-1 px-4 text-xs" style="height: 43px;">
            ...
            <div class="w-4/12 flex items-center justify-end">
                ...
                <el-button color="#45a6eb" class="cursor-pointer ml-2" type="danger" @click="downloadImage">
                    ...
                    <span class="ml-1 text-white">下载</span>
                </el-button>

                <el-button @click="upgradeMembership" color="#45a6eb" type="danger" v-if="!memberVerify">
                    <span class="ml-1 text-white">会员</span>
                </el-button>
...
import { ArrowDown, SwitchButton, Document,User,Present } from '@element-plus/icons-vue'
...
const handleUploadSuccess = async (res) => {
    const url = 'http://slwpvtp0r.sabkt.gdipper.com/' + res.key;
